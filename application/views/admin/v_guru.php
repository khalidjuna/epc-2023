    ...
    <div class="col-md-12">
      ...
      <div class="box box-success" style="overflow-x: scroll;">
        <div class="box-header">
          <center><h4 class="box-title">Data Panitia</h4></center><p>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <center><h4 class="modal-title">Tambah Data Panitia</h4></center>
      </div>
      <!-- /.form dengan modal -->
      <form method="post" action="<?php echo base_url() . 'guru/guru_aksi'; ?>">
        <div class="modal-body">
          <div class="form-group">
            <label class="font-weight-bold">Nama Panitia</label>
            <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama Panitia" required="">
          </div>
          <div class="form-group">
            <label class="font-weight-bold">ID Panitia</label>
            <input type="number" class="form-control" name="ID" placeholder="Masukkan NRP" required="">
          </div>
          <div class="form-group">
